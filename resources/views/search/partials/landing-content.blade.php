...
<section class="py-20 md:py-24 relative"
    ...
    <div class="relative z-10 max-w-6xl mx-auto px-6 py-16 md:px-10">
        ...
        <div class="grid md:grid-cols-3 gap-8">
            ...
            <div class="bg-white/95 backdrop-blur-sm rounded-2xl p-8 text-center shadow-xl hover:shadow-2xl transition-shadow">
                ...
                <h3 class="text-xl font-bold text-white mb-3">Identity Search</h3>
            ...
            <div class="bg-white/95 backdrop-blur-sm rounded-2xl p-8 text-center shadow-xl hover:shadow-2xl transition-shadow">
                ...
                <h3 class="text-xl font-bold text-white mb-3">Reverse Lookup</h3>
                <p class="text-gray-300 text-sm leading-relaxed">
            ...
            <div class="bg-white/95 backdrop-blur-sm rounded-2xl p-8 text-center shadow-xl hover:shadow-2xl transition-shadow">
                ...
                <h3 class="text-xl font-bold text-white mb-3">Location Intelligence</h3>
                <p class="text-gray-300 text-sm leading-relaxed">
...
<section class="py-20 md:py-28 bg-gray-50">
    <div class="max-w-6xl mx-auto px-6 py-16 md:px-10">
...
<section class="py-20 md:py-28 relative"
    ...
    <div class="relative z-10 max-w-3xl mx-auto px-6 py-16 md:px-10 text-center">
